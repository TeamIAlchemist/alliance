    ...
    <main style={wrap}>
          ...
          <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', marginTop: 18 }}>
            <div style={{ flex: 1, minWidth: 300 }}>
              ...
              <div style={{ height: 300 }}><ResponsiveContainer><ScatterChart margin={{ top: 10, right: 10, bottom: 20, left: 0 }}>
                <ReferenceArea x1={4} x2={12} y1={15} y2={25} fill="#a6643c" fillOpacity={0.30} label={{ value: (POL_LABELS as any)[lang].over, position: 'insideTopLeft', fill: 'rgba(236,231,221,0.75)', fontSize: 11, fontWeight: 600 }} />
                <ReferenceArea x1={12} x2={20} y1={15} y2={25} fill="#9aa0a3" fillOpacity={0.12} label={{ value: (POL_LABELS as any)[lang].erratic, position: 'insideTopRight', fill: 'rgba(236,231,221,0.75)', fontSize: 11, fontWeight: 600 }} />
                <ReferenceArea x1={4} x2={12} y1={5} y2={15} fill="#e7dcc4" fillOpacity={0.08} label={{ value: (POL_LABELS as any)[lang].healthy, position: 'insideBottomLeft', fill: 'rgba(236,231,221,0.75)', fontSize: 11, fontWeight: 600 }} />
                <ReferenceArea x1={12} x2={20} y1={5} y2={15} fill="#3f584f" fillOpacity={0.35} label={{ value: (POL_LABELS as any)[lang].rigid, position: 'insideBottomRight', fill: 'rgba(236,231,221,0.75)', fontSize: 11, fontWeight: 600 }} />
                <ReferenceLine x={12} stroke="#ffffff22" /><ReferenceLine y={15} stroke="#ffffff22" />
      ...
      {A && showReport && <section id="report" style={{ marginTop: 20, background: '#ffffff', color: INK, borderRadius: 12, padding: '30px 32px' }}>
        ...
        <div style={{ height: 320 }} className="brk"><ResponsiveContainer><ScatterChart margin={{ top: 10, right: 10, bottom: 20, left: 0 }}>
          <ReferenceArea x1={4} x2={12} y1={15} y2={25} fill="#a6643c" fillOpacity={0.32} label={{ value: (POL_LABELS as any)[lang].over, position: 'insideTopLeft', fill: '#5e3418', fontSize: 11, fontWeight: 700 }} />
          <ReferenceArea x1={12} x2={20} y1={15} y2={25} fill="#9aa0a3" fillOpacity={0.22} label={{ value: (POL_LABELS as any)[lang].erratic, position: 'insideTopRight', fill: '#556066', fontSize: 11, fontWeight: 700 }} />
          <ReferenceArea x1={4} x2={12} y1={5} y2={15} fill="#d8ccae" fillOpacity={0.35} label={{ value: (POL_LABELS as any)[lang].healthy, position: 'insideBottomLeft', fill: '#6a5a34', fontSize: 11, fontWeight: 700 }} />
          <ReferenceArea x1={12} x2={20} y1={5} y2={15} fill="#3f584f" fillOpacity={0.32} label={{ value: (POL_LABELS as any)[lang].rigid, position: 'insideBottomRight', fill: '#25403a', fontSize: 11, fontWeight: 700 }} />
          <ReferenceLine x={12} stroke="#00000018" /><ReferenceLine y={15} stroke="#00000018" />
